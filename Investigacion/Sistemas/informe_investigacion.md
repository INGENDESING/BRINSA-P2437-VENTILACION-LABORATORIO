...
**Documento:** informe_investigacion.md — Revisión 1
**Fecha de consulta de fuentes:** 2026-07-23 (REV0); revisión 1 emitida el 2026-07-27
...
6.1.1. Punto de selección: 3 840 m³/h (2 260 CFM) @ 225 Pa a densidad estándar (equivalente a 165 Pa en el sitio, escenario filtro cargado). El punto corresponde a ≈0.9 in c.a., plenamente cubierto por ventiladores axiales tubulares de PRFV (el catálogo 185 de Aerovent cubre 355-1 525 mm y hasta 370 Pa estática; [Aerovent Catálogo 185 (PDF)](https://www.aerovent.com/wp-content/uploads/sites/2/2024/07/Fiberglass-Fans-Axial-Flow-Model-FBD-FDP-FRV-TFBD-VTFBD-Catalog-185.pdf), consulta 2026-07-27). En REV0, con el punto anterior más exigente, los axiales quedaron descartados frente al centrífugo de álabes curvados hacia atrás; el cambio de alcance del cliente reduce la presión de selección y hace viable el axial, que el cliente ha adoptado como decisión de diseño por sus ventajas en esta aplicación: menor costo de equipo e instalación (montaje directo en muro, sin ductos), mantenimiento simple y, en la ejecución de transmisión por bandas, motor completamente fuera de la corriente de aire corrosiva con posibilidad de ajuste de RPM en comisionamiento. La contrapartida —menor eficiencia (η provisional 0.55) y mayor sensibilidad de la curva a la carga del filtro— es aceptable dada la potencia involucrada (0.320 kW teóricos).

**Tabla 3.** Comparativa de ventiladores axiales candidatos (consulta 2026-07-23, ampliada 2026-07-27).

| Fabricante / línea | Tipo y material | Pros | Contras | Fuente |
|---|---|---|---|---|
| Aerovent FBD (Twin City Fan / Aerovent) — primera opción | Tubeaxial PRFV, transmisión por bandas | Catálogo 185 FRP (355-1 525 mm, hasta 370 Pa estática) cubre el punto de 225 Pa con margen; las bandas dejan el motor fuera de la corriente y permiten ajuste de RPM; laminado PRFV idóneo para cloro | Tamaño y RPM exactos por confirmar con el software del fabricante; canal local por confirmar | [Aerovent Catálogo 185 (PDF)](https://www.aerovent.com/wp-content/uploads/sites/2/2024/07/Fiberglass-Fans-Axial-Flow-Model-FBD-FDP-FRV-TFBD-VTFBD-Catalog-185.pdf) |
| Greenheck VAB/VAD | Vaneaxial, acero con recubrimiento epóxico | Certificación AMCA de desempeño y FEI; representante oficial en Bogotá (Prime Lines HVAC); VAB de bandas admite ajuste de paso y RPM | Recubrimiento epóxico = segunda línea en ambiente clorado (inspección programada); la versión VAD directa deja el motor en la corriente, preferir VAB | [Greenheck Vane Axial VAB/VAD (PDF)](https://content.greenheck.com/public/DAMProd/Original/10003/vane_axial_catalog.pdf); [rep. Colombia](https://www.greenheck.com/find-my-rep/2973_southamerica_colombia) |
| Sodeca HCT/HGT versión anticorrosiva PRFV | Axial tubular PRFV | Filial Sodeca Colombia con catálogo 60 Hz local; plazos y repuestos simples | Confirmar disponibilidad de la ejecución PRFV y la curva en el punto de selección | [Sodeca](https://www.sodeca.com); [catálogo Colombia (PDF)](https://www.sodeca.co/files/catalogs/es/SODECA_CT18_catalogo_resumen_CO.pdf) |
| New York Blower FRP tubeaxial | Tubeaxial PRFV | Experiencia consolidada del fabricante en laminados PRFV; sello AMCA | Sin filial en Colombia; importación (plazo máx. ~3 meses, dato cliente 2026-07-23) | [NYB](https://www.nyb.com/) |
...
6.1.2. Motor: 0.75 HP TEFC (provisional, a confirmar con la curva de la selección final), 1 800 RPM (4 polos, 60 Hz), clase de aislamiento F, IP55 mínimo, ejecución severe duty con pintura epóxica y protección interna anticorrosiva (referencias de especificación: [Leeson/Regal Severe Duty (PDF)](https://www.regalrexnord.com/-/media/documents/brands/literature/industries/leeson_product_catalog_1050.pdf); [Baldor-Reliance IEEE 841XL](https://www.baldor.com/mvc/DownloadCenter/Files/9AKK108319), consulta 2026-07-23). La transmisión por bandas deja el motor fuera de la corriente de aire. Tensión y fases: 440 V, 3φ, 60 Hz (confirmado por el cliente, 2026-07-23).
...
6.4.3. Conexión flexible del ventilador: hipalón (CSM), material recomendado para exterior por resistencia química, ozono y envejecimiento ([Hardcast Hypalon Flexible Duct Connectors (PDF)](https://6c2bd45d09da3c66a408-2b16a407535c695c8a76f8b06a56f342.ssl.cf2.rackcdn.com/GWB%20%20eCatalog%2006-25-16.pdf), consulta 2026-07-23), con bandas de amarre inox 316 en lugar del galvanizado estándar.
...
8.1. La corrección de densidad por altitud (k = 0.733) sigue siendo el factor que gobierna la selección: reduce la presión disponible del ventilador y la ΔP de todos los elementos, y obliga a seleccionar en el punto equivalente de catálogo 3 840 m³/h @ 225 Pa. Ese punto, ≈0.9 in c.a., queda dentro del rango de los axiales tubulares de PRFV, lo que habilita la configuración adoptada por el cliente: ventilador axial de transmisión por bandas montado directamente en el muro, sin ductos de impulsión.

8.2. Selección recomendada: (i) ventilador axial tubeaxial PRFV de transmisión por bandas, Aerovent FBD (Catálogo 185) como primera opción, con Greenheck VAB (vaneaxial epóxico, canal local Prime Lines HVAC, Bogotá), Sodeca HCT/HGT anticorrosivo PRFV, NYB FRP tubeaxial y Plastec PP como alternativas, motor 0.75 HP TEFC severe duty epóxico (provisional); (ii) filtración en dos etapas, prefiltro MERV 8 + filtro final V-bank MERV 13-14 de marco plástico (Camfil Durafil ES2 MERV 14 como referencia de diseño; AAF VariCel VXL y Freudenberg MaxiPleat MX 85 como alternativas), portafiltros inox 304/316; (iii) tres rejillas eggcrate inox 316L de 353×336 mm con malla anti-insectos inox 316 18×18 desmontable, fabricación local a medida (ProAire/Laminaire); (iv) ferretería inox 316, sellante silicona RTV neutra y conexión flexible de hipalón.
