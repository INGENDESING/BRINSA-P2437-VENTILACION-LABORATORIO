...
Los resultados principales indican un caudal de diseño de 64.0 m$^3$/min (3 840 m$^3$/h, 2 260 CFM), una potencia teórica del ventilador de 0.44 kW y una potencia instalada recomendada de 1.0 HP. El diseño cumple con los rangos de renovaciones de aire establecidos por ASHRAE 170, WHO y NIH para laboratorios de control medio y bioseguridad nivel 2. Los datos de contorno obtenidos son aplicables de manera directa a un modelo de dinámica de fluidos computacional (CFD) para la verificación del campo de presiones y la distribución de velocidades dentro del recinto.
