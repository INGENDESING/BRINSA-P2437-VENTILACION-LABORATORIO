...
\begin{table}[htbp]
	...
	\begin{tabularx}{\textwidth}{@{}N>{\hsize=0.9\hsize}X>{\hsize=1.2\hsize}Xc>{\hsize=0.9\hsize}X@{}}
		...
		\multicolumn{1}{c}{\textbf{Item}} & \textbf{Parámetro} & \textbf{Valor} & \textbf{Unidad} & \textbf{Referencia} \\
		\midrule
		& Tipo de ventilador & Axial tubeaxial PRFV, transmisión por bandas (ref. Aerovent FBD, por confirmar) & -- & Criterio de diseño \\
		...
		& Motor provisional & 0.75 HP TEFC anticorrosivo, 440 V, 3$\phi$, 60 Hz (margen de servicio 1.5, a confirmar con catálogo) & -- & Criterio de diseño / cliente \\
