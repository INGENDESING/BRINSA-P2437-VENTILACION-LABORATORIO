...
Los resultados principales indican un caudal de diseño de 64.0 m$^3$/min (3 840 m$^3$/h, 2 260 CFM), una potencia teórica del ventilador de 0.338 kW a las condiciones del sitio (Cajicá, $\rho$ = 0.88 kg/m$^3$) y una potencia instalada recomendada de 1.0 HP. El diseño cumple con los rangos de renovaciones de aire establecidos por ASHRAE 170, WHO y NIH para laboratorios de control medio y bioseguridad nivel 2. El modelo de dinámica de fluidos computacional (CFD), resuelto con inyección a \SI{8}{m/s} y rejillas como \texttt{pressure outlet} a \SI{0}{Pa} gauge, confirma la distribución de velocidades esperada: velocidad máxima de \SI{8}{m/s} en la zona de inyección y velocidades faciales del orden de \SI{3}{m/s} en las rejillas de exfiltración, compatibles con el mantenimiento de la presurización positiva.
