...
En cuarto lugar, se dimensionan las rejillas de exfiltración mediante la Ec. (\ref{eq:area_exfil}), definiendo una velocidad de salida entre 2.5 y 4.0 m/s para limitar el ruido y mantener la presión positiva.
