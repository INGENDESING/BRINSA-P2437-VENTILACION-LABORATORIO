...
La distribución de flujo del recinto fue validada mediante el modelo CFD con la disposición de descarga adoptada (tres rejillas apiladas verticalmente en la pared opuesta a la inyección). Los planos de ubicación del ventilador y las rejillas de descarga se emitirán en la etapa de ingeniería de detalle, con base en esta disposición validada.
