...
\begin{table}[htbp]
	...
	\begin{tabularx}{\textwidth}{@{}NlX@{}}
		...
		& P2437-HV-DTS-001 & Hoja de datos del ventilador de impulsión: centrífugo en PRFV, 3 840 m$^3$/h a 260 Pa (catálogo), motor 1.0 HP TEFC 440 V \cite{dml_hd_vent_001} \\
		...
		& P2437-IC-DTS-001 & Hoja de datos de los instrumentos de presión diferencial: indicador Magnehelic + transmisor MS-121, set-point +25 Pa \cite{dml_hd_inst_001} \\
