...
\begin{enumerate}
	...
	\item El modelo CFD, resuelto con inyección a \SI{8}{m/s} y las tres rejillas apiladas verticalmente en la pared opuesta como salidas tipo \texttt{pressure outlet} a \SI{0}{Pa} gauge (descarga libre a la atmósfera), confirma el campo de velocidades esperado: velocidad máxima de \SI{8}{m/s} en la inyección, velocidades faciales del orden de \SI{3}{m/s} en las tres rejillas y flujo general de salida sin retornos hacia el interior, lo que evidencia una ventilación efectiva del recinto con la disposición solicitada por BRINSA.
\end{enumerate}
