...
\begin{enumerate}
	...
	\item La potencia teórica del ventilador es 0.338 kW para una presión total de 190 Pa a las condiciones del sitio (equivalente de catálogo: 260 Pa a densidad estándar) y una eficiencia del 60 \%. Se recomienda un motor de 1.0 HP para incluir márgenes de operación y degradación de filtros.
	...
	\item El modelo CFD, resuelto con inyección a \SI{8}{m/s} y salidas tipo \texttt{pressure outlet} a \SI{0}{Pa} gauge, confirma el campo de velocidades esperado: velocidad máxima de \SI{8}{m/s} en la inyección, velocidades faciales del orden de \SI{3}{m/s} en las rejillas y flujo general de salida sin retornos hacia el interior.
\end{enumerate}
