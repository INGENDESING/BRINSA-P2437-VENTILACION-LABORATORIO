...
\begin{frontmatter}
	...
	\begin{abstract}
		...
		El presente informe documenta la investigación de mercado y la selección preliminar de los equipos y componentes del sistema de ventilación del laboratorio de análisis industrial de BRINSA en Cajicá (Cundinamarca, 2 558 msnm): ventilador axial mural (placa mural) Ø560 mm en PRFV o ejecución epóxica anticorrosiva con transmisión directa, uniforme con el montaje típico de la planta, etapa de filtración MERV 13-14 alojada en la cubierta intemperie y rejillas de exfiltración con malla anti-insectos que descargan libremente a la atmósfera.
