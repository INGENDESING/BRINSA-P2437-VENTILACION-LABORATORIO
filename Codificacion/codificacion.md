...
al final. El código GP-N-09 del documento se conserva sin sufijo de
...
`P2437-HV-INF-001.pdf` (no `P2437-HV-INF-001 REV0.pdf`).
...
4. **Excepción de nomenclatura para entregables (2026-07-27):** los archivos
   emitidos en `Emisiones/` no llevan sufijo de revisión en el nombre. La
   revisión se documenta en la portada del archivo y en git. Ver §4.3.1.
